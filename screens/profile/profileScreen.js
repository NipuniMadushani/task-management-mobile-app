import { ImageBackground, Modal, Image, TouchableOpacity, StatusBar, StyleSheet, Text, View, ScrollView, SafeAreaView } from 'react-native'
...
const ProfileScreen = ({ navigation }) => {
    ...
    function options() {
        return (
            <View style={styles.optionsWrapper}>
                {optionSort({ iconName: 'person-outline', option: 'Edit profile', onPress: () => { navigation.push('EditProfile') } })}
                {divider()}
                ...
                {divider()}
                {optionSort({ iconName: 'help-circle-outline', option: 'FAQs', onPress: () => { navigation.push('Faq') } })}
                {divider()}
                {logoutOption()}
            </View>
        )
    ...
    function logoutOption() {
        return (
            <TouchableOpacity
                ...
                style={{ ...CommonStyles.rowAlignCenter, marginHorizontal: Sizes.fixPadding, marginVertical: Sizes.fixPadding + 5.0 }}
            >
                <Image
                    source={require('../../assets/images/icons/logout.png')}
                    style={{ width: 18.0, height: 18.0, resizeMode: 'contain' }}
                />
                <Text numberOfLines={1} style={{ ...Fonts.redColor16Medium, flex: 1, marginHorizontal: Sizes.fixPadding }}>
                    Logout
                </Text>
                <Ionicons
    ...
    function divider() {
        return (
            <View style={{ backgroundColor: Colors.extraLightGrayColor, height: 1.0 }} />
        )
    }
        ...
        return (
            ...
            >
                <Ionicons
                    ...
                    color={Colors.blackColor}
                />
                <Text numberOfLines={1} style={{ ...Fonts.blackColor16Medium, flex: 1, marginHorizontal: Sizes.fixPadding }}>
                    {option}
                </Text>
                <Ionicons
                    name='chevron-forward-outline'
    ...
    function userInfo() {
        return (
            <View style={{ ...CommonStyles.rowAlignCenter, marginVertical: Sizes.fixPadding * 3.0, marginHorizontal: Sizes.fixPadding * 2.0, }}>
                <Image
